...
export const darkHighlightStyle = syntaxHighlighting(
  HighlightStyle.define([
    ...
    { tag: tags.heading, color: "oklch(0.9 0 0)" },
    { tag: tags.heading1, color: "oklch(0.9 0 0)" },
    { tag: tags.heading2, color: "oklch(0.9 0 0)" },
    { tag: tags.heading3, color: "oklch(0.9 0 0)" },
    { tag: tags.emphasis, color: "oklch(0.85 0.05 60)" },
    { tag: tags.strong, color: "oklch(0.92 0 0)" },
    { tag: tags.link, color: "oklch(0.7 0.18 250)" },
    { tag: tags.url, color: "oklch(0.6 0.12 250)" },
    { tag: tags.monospace, color: "oklch(0.75 0.15 150)" },
    { tag: tags.strikethrough, color: "oklch(0.556 0 0)" },
    { tag: tags.quote, color: "oklch(0.708 0 0)" },
...
export const lightHighlightStyle = syntaxHighlighting(
  HighlightStyle.define([
    ...
    { tag: tags.heading, color: "oklch(0.2 0 0)" },
    { tag: tags.heading1, color: "oklch(0.2 0 0)" },
    { tag: tags.heading2, color: "oklch(0.2 0 0)" },
    { tag: tags.heading3, color: "oklch(0.2 0 0)" },
    { tag: tags.emphasis, color: "oklch(0.45 0.08 50)" },
    { tag: tags.strong, color: "oklch(0.2 0 0)" },
    { tag: tags.link, color: "oklch(0.45 0.22 250)" },
    { tag: tags.url, color: "oklch(0.5 0.15 250)" },
    { tag: tags.monospace, color: "oklch(0.45 0.18 150)" },
    { tag: tags.strikethrough, color: "oklch(0.556 0 0)" },
    { tag: tags.quote, color: "oklch(0.45 0 0)" },
    { tag: tags.meta, color: "oklch(0.556 0 0)" },
